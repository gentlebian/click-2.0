# Generated by 'click-buildtool elem2make' on Tue Jul 14 22:37:55 EDT 2015
ELEMENT_OBJS__0 = \
adjusttimestamp.o \
aggregateipflows.o \
aggregatenotifier.o \
...
$(ELEMENT_OBJS__6): %.o: ../elements/linuxmodule/%.cc
	$(call cxxcompile,-c $< -o $@,CXX)
$(patsubst %.o,%.s,$(ELEMENT_OBJS__6)): %.s: ../elements/linuxmodule/%.cc
	$(call cxxcompile_nodep,-S $< -o $@,CXX -S)
$(patsubst %.o,%.ii,$(ELEMENT_OBJS__6)): %.ii: ../elements/linuxmodule/%.cc
	$(call cxxcompile_nodep,-E $< -o $@,CXXCPP)
